...
#@cluster local_cluster "heron@localhost" 2 dir=`/home/heron/Dropbox/Copy/ufc_mdcc_hpc/Hash.jl/queens` exename=`/opt/julia-1.8.3/bin/julia` tunnel=true
...
@cluster cluster_lux "tcarneiro@localhost" 2 hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/queens` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem -p 8079` scpflags=`-i /home/heron/hpc-shelf-credential.pem -P 8079` tunnel=true


@launch QueensMulticluster worker:cluster_lux #worker:cluster_2 #worker:cluster_3 #worker:cluster_4
