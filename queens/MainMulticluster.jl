...
@cluster cluster_lux "tcarneiro@localhost" 1 hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/queens` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` tunnel=true identity_file=`/home/heron/hpc-shelf-credential.pem` port=8079
