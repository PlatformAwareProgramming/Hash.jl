...
@cluster cluster_1 "tcarneiropessoa@grvingt-10.nancy.grid5000.fr"  6 hostfile=`/home/tcarneiropessoa/hostfile.1` dir=`/home/tcarneiropessoa/heron/Hash.jl/queens` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` tunnel=true
@cluster cluster_2 "tcarneiropessoa@graoully-12.nancy.grid5000.fr" 6 hostfile=`/home/tcarneiropessoa/hostfile.2` dir=`/home/tcarneiropessoa/heron/Hash.jl/queens` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` tunnel=true
