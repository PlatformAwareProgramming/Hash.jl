...
@cluster cluster_lux1 "tcarneiro@54.147.135.128:8081" nothing 1 which_mpi="OpenMPI" hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
@cluster cluster_lux2 "tcarneiro@54.147.135.128:8081" nothing 4 which_mpi="OpenMPI" hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
...
@cluster cluster_ec2_1s "ubuntu@3.236.50.3" nothing 1 hostfile=`/home/ubuntu/hostfile` dir=`/home/ubuntu/Hash.jl/gemm` exename=`/usr/local/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
@cluster cluster_ec2_1w "ubuntu@3.236.50.3" nothing 4 hostfile=`/home/ubuntu/hostfile` dir=`/home/ubuntu/Hash.jl/gemm` exename=`/usr/local/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
@cluster cluster_ec2_2s "ubuntu@54.152.31.102" nothing 1 hostfile=`/home/ubuntu/hostfile` dir=`/home/ubuntu/Hash.jl/gemm` exename=`/usr/local/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
@cluster cluster_ec2_2w "ubuntu@54.152.31.102" nothing 4 hostfile=`/home/ubuntu/hostfile` dir=`/home/ubuntu/Hash.jl/gemm` exename=`/usr/local/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
