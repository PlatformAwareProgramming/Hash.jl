...
@cluster cluster_ec2_1 "ubuntu@3.235.144.104" nothing 1 hostfile=`/home/ubuntu/hostfile` dir=`/home/ubuntu/Hash.jl/gemm` exename=`/usr/local/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
@cluster cluster_ec2_2 "ubuntu@54.165.172.234" nothing 2 hostfile=`/home/ubuntu/hostfile` dir=`/home/ubuntu/Hash.jl/gemm` exename=`/usr/local/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem` tunnel=true
