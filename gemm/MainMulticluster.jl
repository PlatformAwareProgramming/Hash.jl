...
#@cluster cluster_1 "tcarneiropessoa@grvingt-13.nancy.grid5000.fr"  6 hostfile=`/home/tcarneiropessoa/hostfile.1` dir=`/home/tcarneiropessoa/heron/Hash.jl/gemm` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` tunnel=true
...
#@launch GEMM_multicluster_entry source:cluster_s1 worker:cluster_w1
