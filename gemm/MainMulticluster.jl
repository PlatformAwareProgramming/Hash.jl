...
@cluster cluster_1 "tcarneiropessoa@grvingt-18.nancy.grid5000.fr"  4 hostfile=`/home/tcarneiropessoa/hostfile.1` dir=`/home/tcarneiropessoa/heron/Hash.jl/gemm` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` tunnel=true
...
#@cluster cluster_lux "tcarneiro@localhost" 4 hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/tcarneiropessoa/heron/hpc-shelf-credential.pem -p 8079` scpflags=`-i /home/tcarneiropessoa/heron/hpc-shelf-credential.pem -P 8079` tunnel=true
@cluster cluster_lux "tcarneiro@localhost" 4 hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem -p 8079` scpflags=`-i /home/heron/hpc-shelf-credential.pem -P 8079` tunnel=true
...
@launch GEMM_multicluster_entry source:cluster_1 source:cluster_lux worker:cluster_1 worker:cluster_lux
