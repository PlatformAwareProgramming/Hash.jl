...
#@cluster cluster_g1 "tcarneiropessoa@54.242.195.65" 1 which_mpi="OpenMPI" hostfile=`/home/tcarneiropessoa/hostfile.1` dir=`/home/tcarneiropessoa/heron/Hash.jl/gemm` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` sshflags=`-i /home/tcarneiropessoa/heron/.ssh-carneiro/id_rsa -p 8080` scpflags=`-i /home/tcarneiropessoa/heron/.ssh-carneiro/id_rsa -P 8080` tunnel=true
#@cluster cluster_g2 "tcarneiropessoa@54.242.195.65" 4 which_mpi="OpenMPI" hostfile=`/home/tcarneiropessoa/hostfile.1` dir=`/home/tcarneiropessoa/heron/Hash.jl/gemm` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` sshflags=`-i /home/tcarneiropessoa/heron/.ssh-carneiro/id_rsa -p 8080` scpflags=`-i /home/tcarneiropessoa/heron/.ssh-carneiro/id_rsa -P 8080` tunnel=true
@cluster cluster_g1 "tcarneiropessoa@54.242.195.65:8080" nothing 1 which_mpi="OpenMPI" hostfile=`/home/tcarneiropessoa/hostfile.1` dir=`/home/tcarneiropessoa/heron/Hash.jl/gemm` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem -P 8080` tunnel=true
@cluster cluster_g2 "tcarneiropessoa@54.242.195.65:8080" nothing 4 which_mpi="OpenMPI" hostfile=`/home/tcarneiropessoa/hostfile.1` dir=`/home/tcarneiropessoa/heron/Hash.jl/gemm` exename=`/home/tcarneiropessoa/julia-1.8.2/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem -P 8080` tunnel=true
...
@cluster cluster_s11 "heron@localhost" 1 hostfile=`/home/heron/hostfile` dir=`/home/heron/Dropbox/Copy/ufc_mdcc_hpc/Hash.jl/gemm` exename=`/opt/julia-1.8.3/bin/julia` tunnel=true
@cluster cluster_s12 "heron@localhost" 4 hostfile=`/home/heron/hostfile` dir=`/home/heron/Dropbox/Copy/ufc_mdcc_hpc/Hash.jl/gemm` exename=`/opt/julia-1.8.3/bin/julia` tunnel=true
#@cluster cluster_w1 "heron@localhost" 6 hostfile=`/home/heron/hostfile` dir=`/home/heron/Dropbox/Copy/ufc_mdcc_hpc/Hash.jl/gemm` exename=`/opt/julia-1.8.3/bin/julia` tunnel=true

#@cluster cluster_lux1 "tcarneiro@54.242.195.65" 1 which_mpi="OpenMPI" hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/tcarneiropessoa/heron/hpc-shelf-credential.pem -p 8081` scpflags=`-i /home/tcarneiropessoa/heron/hpc-shelf-credential.pem -P 8081` tunnel=true
#@cluster cluster_lux2 "tcarneiro@54.242.195.65" 4 which_mpi="OpenMPI" hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/tcarneiropessoa/heron/hpc-shelf-credential.pem -p 8081` scpflags=`-i /home/tcarneiropessoa/heron/hpc-shelf-credential.pem -P 8081` tunnel=true
@cluster cluster_lux1 "tcarneiro@54.242.195.65:8081" nothing 1 which_mpi="OpenMPI" hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem -P 8081` tunnel=true
@cluster cluster_lux2 "tcarneiro@54.242.195.65:8081" nothing 4 which_mpi="OpenMPI" hostfile=`/home/users/tcarneiro/heron/hostfile` dir=`/home/users/tcarneiro/heron/Hash.jl/gemm` exename=`/home/users/tcarneiro/heron/julia-1.8.5/bin/julia` sshflags=`-i /home/heron/hpc-shelf-credential.pem` scpflags=`-i /home/heron/hpc-shelf-credential.pem -P 8081` tunnel=true
