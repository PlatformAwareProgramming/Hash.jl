...
myrank(::Type{Cluster}) = MPI.Comm_rank(MPI.COMM_WORLD) 

function unit_macro_result(level::Type{Cluster}, ::Val{is_level_top}, ::Val{uname}, unit_uids, flag, block#=, global_uids, local_uids=#) where {uname, is_level_top}
